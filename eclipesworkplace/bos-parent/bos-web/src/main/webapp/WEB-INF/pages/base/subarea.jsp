...
<script type="text/javascript">
	...
	var toolbar = [ {
		...
		id : 'button-showProviceHighCharts',
		text : '展示区域分区的数量',
		iconCls : 'icon-search',
		handler : showProviceHighCharts
	}];
	// 定义列
	var columns = [ [ {
		field : 'id',
	...
	function showProviceHighCharts(){
		$('#showHighcharts').window("open");
		$.post("${pageContext.request.contextPath}/subareaAction_findSubareaByProvince",function(data){
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="查询分区窗口" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<!-- 展示省份分区关系 -->
	<div class="easyui-window" title="查询分区窗口" id="showHighcharts" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="overflow:auto;padding:5px;" border="false" id="container">
		</div>
	</div>
</body>
</html>