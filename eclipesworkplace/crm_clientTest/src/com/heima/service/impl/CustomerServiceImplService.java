 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://impl.service.heima.com/", wsdlLocation = "http://localhost:8080/bos_crm/service/customer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.heima.com/", "CustomerServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/bos_crm/service/customer?wsdl");
    ...
    public CustomerService getCustomerServiceImplPort() {
        return super.getPort(new QName("http://impl.service.heima.com/", "CustomerServiceImplPort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.heima.com/", "CustomerServiceImplPort"), CustomerService.class, features);
    }
