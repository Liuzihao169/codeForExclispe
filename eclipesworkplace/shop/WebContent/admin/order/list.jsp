...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function findOrderInfoByOid(obj){
				  $("#showDivTab").html("");//清除之前的列表
				   $("#shodDivOid").html("");//清除之前的oid
			     	 $("#loading").css("display","block");//每次执行之前让他转
				      $.post(
					...
					function(data){
						...
						var context="<tr id='showTableTitle'><th width='20%'>图片</th><th width='25%'>商品</th><th width='20%'>价格</th><th width='15%'>数量</th><th width='20%'>小计</th></tr>"
							for(var i=0;i<data.length;i++){
								context+="<tr style='text-align: center;'>"+
							"<td>"+
						...
						/* location.href="${pageContext.request.contextPath}/admin?method=findOrderInfoByOid&oid="+obj; 
						[{"pimage":"products/1/c_0034.jpg","shop_price":4499.0,"subtotal":4499.0,"pname":"联想（Lenovo）小新V3000经典版","count":1},
							{"pimage":"products/1/c_0010.jpg","shop_price":2599.0,"subtotal":2599.0,"pname":"华为 Ascend Mate7","count":1}]*/
			}
		</script>
	...
	<body>
        ...
        <div id="showDiv" class="blk" style="display:none;">
            <div class="main">
                <h2>订单编号：<span id="shodDivOid" style="font-size: 13px;color: #999">123</span></h2>
                <a href="javascript:void(0);" id="closeBtn" class="closeBtn">关闭</a>
                <div id="loading" style="padding-top:30px;text-align: center;">
                	<img alt=""  style="height:100px;width:100px"src="${pageContext.request.contextPath }/image/timg.gif">
                </div>
