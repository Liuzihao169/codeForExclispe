				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a id="cart" href="javascript:void(0)"> <input style="background: url('./images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0); height: 36px; width: 127px;"
								value="加入购物车" type="button">
							</a> &nbsp;收藏商品
						</div>
						<div>
							<a
								href="${pageContext.request.contextPath}/product?currentpage=${currentpage}&cid=${cid}&method=productlistbycid">返回商品列表</a>
						</div>
					</div>
				</div>
			</div>
