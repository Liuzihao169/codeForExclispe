...
<body>
	...
	<form id="Form1" name="Form1"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				<tr>
					<td class="ta_01" align="center" bgColor="#CCCCCC"><strong>商品列表</strong>
					</TD>
				</tr>
				<tr>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #CCCCCC">

								<td align="center" width="18%">序号</td>
								<td align="center" width="17%">商品图片</td>
								<td align="center" width="17%">商品名称</td>
								<td align="center" width="17%">商品价格</td>
								<td align="center" width="17%">产品型号</td>
							...
							<c:forEach items="${pagebean.productlistbycid }" var="pro"
								...
								<tr onmouseover="this.style.backgroundColor = '#CCCCCC'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${pro.price}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${pro.pversion }</td>
									...
									<a href="javascript:void0()" onclick="checkDel('${pro.pid}')">
