...
<BODY>
<FORM id=form1 name=form1  method=post action="${pageContext.request.contextPath}/userAction_regist">
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <!-- 往root栈当中取值  <p style="color:red"><s:property value="exception.message"/></p> -->
               <!-- 从context域当中获得存储进去的错误信息 -->
